jQuery(document).ready(function($) {
  ...
  var displayBackgroundPhoto = function() {
    return $("body").css(
      "background",
      "rgba(0, 0, 0, .8) url(img/" +
        chooseBackgroundPhoto(weather_code, photos) +
        ".jpg)"
    );
  };
  ...
  $search.on("typeahead:selected", function(event, selection) {
    ...
    var openWeatherAPI =
      "https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?appid=68d06ff44fb97dc7a6ea98b54f8374ba&callback=";
